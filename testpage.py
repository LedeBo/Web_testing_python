...
class OperationsHelper(BasePage):
    ...
    def enter_content(self, word):
        self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_CONTENT_FIELD"], word, description="post content form")

    def enter_name(self, word):
        self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_CONTACT_NAME_FIELD"], word, description="name form")

    def enter_email(self, word):
        self.enter_text_into_field(TestSearchLocators.ids["LOCATOR_CONTACT_EMAIL_FIELD"], word, description="email form")
    ...
    def contact_us_save_button(self):
        self.click_button(TestSearchLocators.ids["LOCATOR_CONTACT_SAVE_BTN"], description="contact save")

    # GET TEXT

    def get_title_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_TITLE_TEXT"], description="title")

    def get_error_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_ERROR_FIELD"], description="error label")

    def get_profile_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_USER_PROFILE_NAME"], description="user profile name")
